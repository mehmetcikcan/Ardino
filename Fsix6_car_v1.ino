 ...
 if (rc_values[RC_CH2] > 1550){
        ...
        if (rc_values[RC_CH1] > 1500){
             ...
             if (rc_values[RC_CH1] > 1550){
              pwm1=map(rc_values[RC_CH1], 1550, 2000, 0, 255);
              if (pwm1>255){pwm1=255;}
              if (pwm1<0){pwm1=0;}
            //  Serial.print(" sol: ");
            //  Serial.println(pwm1);
              analogWrite(backwardright,0);
              analogWrite(backwardleft, pwm1);
              analogWrite(forwardleft,0);
              analogWrite(forwardright, pwm1);}

              else if (rc_values[RC_CH1] < 1450){
              pwm2=map(rc_values[RC_CH1], 1450, 1000, 0, 255);
           ...
           //   Serial.println(pwm2);
              ...
              analogWrite(backwardright, pwm2);
              analogWrite(forwardright,0);
              analogWrite(forwardleft, pwm2);}
